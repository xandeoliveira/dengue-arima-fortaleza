...
url = "https://info.dengue.mat.br/api/alertcity?&disease=dengue&geocode=2304400&disease=dengue&format=csv&ew_start=1&ew_end=26&ey_start=2014&ey_end=2025"
...
# Salvando dataframe...
df_filtrado.to_csv(getcwd() + "/fortaleza-26-2025.csv")
